...
engine.say("One person, close, in front of you")
# engine.say("Satu orang, dekat, di depan")
engine.runAndWait()
input()

engine.say("Two cars, distant, on your right")
# engine.say("Dua mobil, jauh, di kanan")
engine.runAndWait()
input()

engine.say("Three chairs, close, on your left")
...
engine.say("One laptop and two persons, distant, in front of you")
# engine.say("Satu laptop, dan dua orang, jauh, di depan")
engine.runAndWait()
input()

engine.say("Three bottles, three cars, two tables, close, in front of you")
