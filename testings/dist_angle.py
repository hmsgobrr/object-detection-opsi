# Pengujian jarak maksimum dan besar sudut penglihatan alat
# Pengujian dijalankan menggunakan laptop Lenovo X1 Carbon

# To allow module import from root dir
import sys
sys.path.append("..")
...
parser.add_argument('-i', '--input', help='camera index')
